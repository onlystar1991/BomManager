class SubCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sub_category.save
        ...
        format.json {
          render json: {
            ...
            sub_category: {
              ...
              category_id: @sub_category.part_category_id
            }
          },
          status: :ok
        }
        ...
        format.json { render json: @sub_category.errors.full_messages, status: :ok }
      end
    end
  ...
  private
    ...
    def sub_category_params
      params.require(:sub_category).permit(:name, :part_category_id)
    end
end
