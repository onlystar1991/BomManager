class PartCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @part_category.save
        ...
        format.json {
          render json: {
            ...
            part_category: {
              ...
              description: @part_category.description,
              photo: @part_category.photo.url
            }
          },
          status: :ok
        }
        ...
        format.json { render json: @part_category.errors.full_messages, status: :ok }
      end
    end
  end
  ...
  private
    ...
    def part_category_params
      params.require(:part_category).permit(:name, :description, :photo)
    end
end
